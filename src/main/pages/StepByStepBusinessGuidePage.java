...
public class StepByStepBusinessGuidePage extends PageBase{
    ...
    @FindBy(css = "div>div>label:nth-child(1)") public WebElement option1;
    @FindBy(css = "div>div>label:nth-child(2)") public WebElement option2;
    @FindBy(css = "div>div>label:nth-child(3)") public WebElement option3;
    @FindBy(css = "div>div>label:nth-child(4)") public WebElement option4;
    @FindBy(css = "div>div>label:nth-child(5)") public WebElement option5;
    @FindBy(css = "div>div>label:nth-child(6)") public WebElement option6;
